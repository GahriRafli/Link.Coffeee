	...
	<div class="card col-lg-12">
		<div class="card-body">
			<form action="" id="manage-settings">
				...
				<br>
				<div class="form-group">
					<label for="about" class="control-label">Konten untuk Hal.Tentang</label>
				...
				<center>
					<button class="btn btn-info btn-primary btn-block col-md-5">Simpan</button>
				</center>
			</form>
		</div>
	</div>
	...
	$('#manage-settings').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Data telah disimpan.','success')
					setTimeout(function(){
						location.reload()
					},1000)
				}
