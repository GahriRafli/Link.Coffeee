            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Daftar Keranjang</h3>
        ...
        <div class="container">
        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Keranjang</b></div>
				...
				$qry = $conn->query("SELECT * FROM cart");
        		...
        		<div class="card">
	        		<div class="card-body">
						...
						<div class="col-md-4" style="text-align: -webkit-center">
			        			<button class="rem_cart btn btn-sm btn-outline-danger" data-id="<?php echo $row['cid'] ?>"><i class="fa fa-trash"></i></a></button>
			        		...
			        		<div class="col-md-4">
			        			...
			        			<p> <b><small>Harga: <?php echo number_format($row['price'],3) ?></small></b></p>
			        			<p><small>QTY :</small></p>
			        			...
			        			<div class="input-group mb-3">
								  ...
								  <input type="number" value="<?php echo $row['qty'] ?>" min = 1 class="form-control text-center" name="qty" >
								  <div class="input-group-prepend">
			        		...
			        		<div class="col-md-4 text-right">
			        			<b><large><?php echo number_format($row['qty'] * $row['price'],3) ?></large></b>
			        		</div>
		        		</div>
	        		</div>
	        	</div>
        	...
        	<div class="col-md-4">
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					<p><large>Total Belanja</large></p>
        					<hr>
        					<p class="text-right"><b><?php echo number_format($total,3) ?></b></p>
        					<hr>
