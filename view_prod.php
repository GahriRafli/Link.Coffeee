	...
	<div class="card ">
        ...
        <div class="card-body">
          ...
          <div class="row">
			  ...
			  <input type="number" min = 1 class="form-control text-center" name="qty" >
			  <div class="input-group-prepend">
          ...
          <div class="text-center">
          	<button class="btn btn-outline-primary btn-sm btn-block" id="add_to_cart_modal"><i class="fa fa-cart-plus"></i>Tambah Keranjang</button>
          </div>
        </div>
	...
	$('#add_to_cart_modal').click(function(){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1 )
					alert_toast("Order Telah Masuk Keranjang");
