 <!-- Masthead-->
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Selamat Datang di <?php echo $_SESSION['setting_name']; ?></h3>
                        <hr class="divider my-4" />
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="#menu">Pesan Sekarang</a>
	...
	<section class="page-section" id="menu">
         <h2 style="text-align: justify; text-indent: 0.2in;">Produk</h2>
         <br>
        <div id="menu-field" class="card-deck">
                <?php 
                    ...
                    ?>
                    <div class="w-50 p-3 col-lg-3 col-md-3 col-sm-3 col-xl-3 col-xxl-3">
